...
<section class="news_side">
	<div class="news_detail_tit">
		...
		<div class="news_detail_tit_s">
			<div class="news_detail_tit_s_l">
				<em><?php echo ($Info["cate_title"]); ?></em><span><?php echo ($Info["addtime"]); ?>       阅读（<?php echo ($Info["clickcount"]); ?>）</span>
			</div>
...
<div class="clear"></div>
	...
	<div class="news_side_list">
		<article class="news_side_list_left news_detail_info">
