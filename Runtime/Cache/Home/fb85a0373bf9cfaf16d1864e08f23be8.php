	...
	<ul>
		...
		<!-- <li>
			...
			<article class="basic_info_right">
				...
				<div class="basic_info_side collection_side">
					<div class="home_fication">
						<ul>
							<li>
								<a href="">
									新房 <span>(90)</span>
							...
							<li class="coll_sub">
								<a href="">
									二手房 <span>(<?php echo ($data["count"]); ?>)</span>
								</a>
							</li>
							<div class="clear"></div>
						</ul>
					...
					<div class="collection_list">
						<ul>
							<?php if(is_array($data["list"])): foreach($data["list"] as $k=>$value): ?><li>
									<div class="collection_list_time"><?php echo ($k); ?></div>
									<div class="collection_l_info">
										<dl>
											<?php if(is_array($value)): $i = 0; $__LIST__ = $value;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><dd class="conduct">
													<a href="<?php echo U('Subject/detail',array('id'=>$vo['id']));?>">
														<figure>
															<img src="<?php echo (get_img($vo["image"])); ?>" alt="">
															<figcaption>
																<p><?php echo ($vo["title"]); ?></p>
																<em>当前价</em><span>¥ <?php echo (money_to_wan($vo["current_price"])); ?>万</span>
															</figcaption>

														</figure>
													</a>
													<?php if($vo["sale_type"] == 1): ?><div class="col_t_l">
															<i  class="iconfont">&#xe79b;</i>一口价
														</div><?php endif; ?>
													<div class="col_t_r">
														<a href="javascript:;" data-status="1" onclick="collection(this,<?php echo ($vo["id"]); ?>)">
															<i class="iconfont">&#xe68e;</i>
														</a>
													</div>
													<div class="conducts_tip">
