	...
	<ul>
		...
		<!-- <li>
			...
			<article class="basic_info_right">
				...
				<div class="basic_info_side recharge_side">
					<img src="/qupaifang/Tpl/Home/Public/images/zfb.png" alt="">
					<p>
						支付宝充值到余额支付宝充值到余额支支付宝充值到余额支付宝充值到余额支付宝充值到余额支付宝充值到余额支付宝充值到余额支付宝充值到余额支付宝充值到余额支付宝充值到余额付宝充值到余额支付宝充值到余额支付宝充值到余额支付宝充值到余额支付宝充值到余额支付宝充值到余额
					</p>
					<div class="recharge_side_price">
						<p>账户余额：<span><?php echo (number_format($info["balance"])); ?></span>元</p>
						<div class="recharge_s_p_info">
							<input name="textfield" type="text" value="请输入提现金额"onfocus="if (value =='请输入提现金额'){value =''}"onblur="if (value ==''){value='请输入提现金额'}"/>
							<span>元</span>
							<div class="clear"></div>
						</div>
						<button>提现</button>
