	...
	<div class="news_side_title">
		<ul>
			<?php if(is_array($Category)): $i = 0; $__LIST__ = $Category;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><li>
					<a href="<?php echo U('Article/index',array('catid'=>$vo['id']));?>">
						<?php echo ($vo["title"]); ?>
					</a>
		...
		<article class="news_side_list_left">
			<div class="news_banner_scroll">
				<div class="flexslider">
					<ul class="slides">
						<?php if(is_array($Recommend)): $i = 0; $__LIST__ = $Recommend;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><li style="background:url(<?php echo (get_img($vo["img"])); ?>) 50% 0 no-repeat;">
			...
			<div class="news_list_all">
				<ul>
					<?php if(is_array($List)): $i = 0; $__LIST__ = $List;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><li>
							<a href="<?php echo U('Article/detail',array('id'=>$vo['id']));?>"><h3><?php echo ($vo["title"]); ?></h3></a>
							<div class="news_list_all_side">
								...
								<div class="news_side_info">
									<div class="news_side_info_t">
										<em><?php echo ($vo["cate_title"]); ?></em>
										<span><?php echo ($vo["addtime"]); ?></span>
										<span>阅读（<?php echo ($vo["clickcount"]); ?>）</span>
										<i class="iconfont">&#xe600;</i>
										<div class="clear"></div>
