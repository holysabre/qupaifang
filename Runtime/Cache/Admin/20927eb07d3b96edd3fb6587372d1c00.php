...
<div class="layui-tab layui-tab-brief main-tab-container">
  <ul class="layui-tab-title main-tab-title">
    ...
    <a href="<?php echo U('edit');?>"><li>添加 / 编辑管理员</li></a>
    <a href="<?php echo U('role');?>"><li class="layui-this">角色列表</li></a>
    <a href="<?php echo U('role_edit');?>"><li>添加 / 编辑角色</li></a>
    <div class="main-tab-item">管理员管理</div>
  </ul>
  <div class="layui-tab-content">
    <div class="layui-tab-item layui-show">
    <form class="layui-form">
      <table class="list-table tablelist" id="listTable" data-url="<?php echo U('ajax_edit?table=admin_role');?>">
        <thead>
          <tr>
            <th width="50">ID</th>
            <th width="100">名称</th>
        ...
        <?php if(is_array($data)): $i = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
            ...
            <a href="<?php echo U('role_edit',array('id'=>$vo['id']));?>" class="layui-btn layui-btn-small" title="编辑"><i class="layui-icon"></i></a>
            <?php if($vo["is_system"] != 1): ?><a class="layui-btn layui-btn-small layui-btn-danger del_btn" data-id="<?php echo ($vo["id"]); ?>" title="删除" data-name='<?php echo ($vo["name"]); ?>'><i class="layui-icon"></i></a><?php endif; ?>
            </td>
...
layui.use(['element', 'layer', 'form'], function(){
  ...
  jq('.del_btn').click(function(){
    ...
    layer.confirm('确定删除【'+name+'】?', function(index){
      ...
      jq.post('<?php echo U("deleteRole");?>',{'id':id},function(data){
        if(data.status == 1){
          layer.close(loading);
