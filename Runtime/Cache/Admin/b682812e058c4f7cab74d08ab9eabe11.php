...
<div class="layui-tab layui-tab-brief main-tab-container">
  <ul class="layui-tab-title main-tab-title">
    <a href="<?php echo U('index');?>"><li class="layui-this">管理员列表</li></a>
    <a href="<?php echo U('edit');?>"><li>添加 / 编辑管理员</li></a>
    <?php if($admin["is_system"] == 1): ?><a href="<?php echo U('role');?>"><li>角色列表</li></a>
      <a href="<?php echo U('role_edit');?>"><li>添加 / 编辑角色</li></a><?php endif; ?>
    <div class="main-tab-item">管理员管理</div>
  </ul>
  <div class="layui-tab-content">
    <div class="layui-tab-item layui-show">
    <form class="layui-form">
      <table class="list-table tablelist" id="listTable" data-url="<?php echo U('ajax_edit?table=admin');?>">
        <thead>
          <tr>
        ...
        <?php if(is_array($data)): $i = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
            ...
            <!-- <a href="<?php echo U('log',array('id'=>$vo['id']));?>" class="layui-btn layui-btn-small" title="登录记录"><i class="fa fa-list-alt"></i></a> -->
