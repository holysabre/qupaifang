...
<div class="layui-tab-brief main-tab-container">
    <ul class="layui-tab-title main-tab-title">
      <a href="<?php echo U('index');?>"><li>幻灯片列表</li></a>
      <a href="<?php echo U('edit');?>"><li class="layui-this">添加幻灯片</li></a>
      <div class="main-tab-item">幻灯片管理</div>
    </ul>
          ...
          <div class="layui-tab layui-tab-card">
            ...
            <div class="layui-tab-content">
              <div class="layui-tab-item layui-show">
                ...
                <?php echo Form::input('text','width',$info['width'],'宽度','（单位：px）','','');?>
                <?php echo Form::input('text','height',$info['height'],'高度','（单位：px）','','');?>
                <?php echo Form::upload('album', $info['album'], '图片', '','banner',true);?>
              </div>
