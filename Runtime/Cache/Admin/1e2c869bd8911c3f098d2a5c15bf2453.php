...
<div class="layui-tab layui-tab-brief main-tab-container">
    <ul class="layui-tab-title main-tab-title">
      <a href="<?php echo U('index');?>"><li class="layui-this">友情链接列表</li></a>
      <a href="<?php echo U('edit');?>"><li>添加 / 编辑友情链接</li></a>
    ...
    <div class="layui-tab-content">
      ...
      <form class="layui-form">
        <table class="list-table tablelist" id="listTable" data-url="<?php echo U('ajax_edit?table=article');?>">
          <thead>
            <tr>
