...
<div class="layui-tab layui-tab-brief main-tab-container">
    <ul class="layui-tab-title main-tab-title">
      <a href="<?php echo U('index');?>"><li class="layui-this">产品列表</li></a>
    ...
    <div class="layui-tab-content">
      ...
      <form class="layui-form">
        <table class="list-table tablelist" id="listTable" data-url="<?php echo U('ajax_edit?table=products');?>">
          <thead>
            <tr>
          ...
          <tbody>             
            <?php if(is_array($data["list"])): $i = 0; $__LIST__ = $data["list"];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                ...
                <td><?php echo (get_span($vo["title"],$vo['id'],'title')); ?></td>
                <td><?php echo ($category[$vo['catid']]['title']); ?></td>
                <td><img src="<?php echo ($vo["img"]); ?>" width="50"></td>
                <td><?php echo ($vo["price"]); ?></td>
                <td <?php if($vo["stock"] == 0): ?>style="color:red;"<?php endif; ?>><?php echo ($vo["stock"]); ?></td>
