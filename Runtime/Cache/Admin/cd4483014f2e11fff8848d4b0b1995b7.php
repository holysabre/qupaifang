...
<div class="layui-tab layui-tab-brief main-tab-container">
    <ul class="layui-tab-title main-tab-title">
      <a href="<?php echo U('index');?>"><li class="layui-this">会员列表</li></a>
    ...
    <div class="layui-tab-content">
      ...
      <form class="layui-form">
        <table class="list-table tablelist" id="listTable" data-url="<?php echo U('ajax_edit?table=page');?>">
          <thead>
            <tr>
          ...
          <?php if(is_array($data)): $i = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
              ...
              <td><?php echo (get_span($vo["nickname"],$vo['id'],'nickname')); ?></td>
              <td><?php echo (get_span($vo["mobile"],$vo['id'],'mobile')); ?></td>
              <td><?php echo ($vo["login_times"]); ?></td>
              <td><?php echo (get_toggle($vo["is_enable"],$vo['id'],'is_enable')); ?></td>
              <td style="text-align: center;">
              <!-- <a href="<?php echo U('address',array('id'=>$vo['id']));?>" class="layui-btn layui-btn-small" title="收货地址"><i class="fa fa-truck"></i></a> -->
              <a href="<?php echo U('wallet',array('m_id'=>$vo['id']));?>" class="layui-btn layui-btn-small" title="个人账户"><i class="fa fa-dollar"></i></a>
