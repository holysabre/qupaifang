...
<div class="layui-tab layui-tab-brief main-tab-container">
    <ul class="layui-tab-title main-tab-title">
      ...
      <a href="<?php echo U('category');?>"><li class="layui-this">产品分类列表</li></a>
      ...
      <form class="layui-form">
        <table class="list-table tablelist" id="listTable" data-url="<?php echo U('ajax_edit?table=category');?>">
          ...
          <?php if(is_array($data)): $i = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
              ...
              <td><?php echo ($vo["title_show"]); echo (get_span($vo["title"],$vo['id'],'title')); ?></td>
              <td><?php echo (get_span($vo["html"],$vo['id'],'html')); ?></td>
              <td><?php echo (get_span($vo["templete"],$vo['id'],'templete')); ?></td>
              <td><?php echo (get_toggle($vo["is_show"],$vo['id'],'is_show')); ?></td>
              <td><?php echo (get_span($vo["sort"],$vo['id'],'sort')); ?></td>
              <td style="text-align: center;">
              <a href="<?php echo U('category_edit',array('id'=>$vo['id']));?>" class="layui-btn layui-btn-small" title="编辑"><i class="layui-icon"></i></a>
